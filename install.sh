...
install_dependencies() {
  local debian_packages=(ca-certificates curl jq openssl tar iproute2 coreutils ethtool)
  local redhat_packages=(ca-certificates curl jq openssl tar iproute coreutils ethtool)
  local alpine_packages=(ca-certificates curl jq openssl tar iproute2 coreutils ethtool)
